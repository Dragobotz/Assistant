...
startbtn = InlineKeyboardMarkup(
               [
                [
                    InlineKeyboardButton(text='❤️\u200d🔥Owner❤️\u200d🔥', url='https://t.me/GOD_DRAGOOP'),
                    InlineKeyboardButton(text='⭕️Subscribe⭕️', url='https://www.youtube.com/@DragoXServer')
                ],
                [
...
async def startgmsg(_, message):
    await message.reply_photo(photo="https://te.legra.ph/file/7c7492783613dc2bbb4bf.jpg", 
    caption=f"Hey {message.from_user.mention}☄️. \n\nI am the Assistant bot of GOD DRAGOOP.",
    reply_markup = InlineKeyboardMarkup(
                 [
                  [ InlineKeyboardButton(text='Visit PM', url='https://t.me/GOD_DRAGOOP') ],
                  [ InlineKeyboardButton(text='◈━━━━━━◈', callback_data='stats_callback') ]
                 ]
))
...
async def startmenu(_, query: CallbackQuery):
    await query.edit_message_text(
        text=f"**✨Hello {query.from_user.mention}🙋\n🌺I am The Assistant Bot Of [GOD DRAGOOP](https://t.me/GOD_DRAGOOP)**.\n\n__💬You Can Contract Him Using This Bot.\n📨Send Your Messages Normally And I Will Forward Them To Him.__",
...
BOTIMG='https://te.legra.ph/file/7c7492783613dc2bbb4bf.jpg'
BOTBTNS = InlineKeyboardMarkup(
                               [
                                [InlineKeyboardButton(text='Visit Bot', url='https://t.me/GOD_DRAGOOP_BOT')],
...
HYPERBTNS = InlineKeyboardMarkup(
              [
                [
                  InlineKeyboardButton('⚡𝘿𝙧𝙖𝙜𝙤 ✘ 𝙎𝙚𝙧𝙫𝙚𝙧️🤟' , url='https://t.me/DragoXServer')
                ],
                [
                  InlineKeyboardButton('👥 Group 👥' , url='https://t.me/DragoXServerChat'),
                ], 
                [
...
async def postcallbacc(_, CallbackQuery):
    await bot.answer_callback_query(CallbackQuery.id, text="🔆Shared Via @GOD_DRAGOOP_BOT...", show_alert=False)
   ...
   if inline_query.query=='':
        await inline_query.answer(
            ...
            InlineQueryResultPhoto(
                title=f"𝘿𝙧𝙖𝙜𝙤 ✘ 𝙎𝙚𝙧𝙫𝙚𝙧 | 🇮🇳",
                description="Click Here To Share",
                photo_url="https://te.legra.ph/file/ad0cd306ff1f523cc36b4.jpg",
                thumb_url="https://te.legra.ph/file/ad0cd306ff1f523cc36b4.jpg",
                caption=HYPERTXT,
...
bot.start()
LOGGER.info("DragoOp's assistant is online")
idle()
